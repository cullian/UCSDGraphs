...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 // new list of two hops to return
		 List<Integer> twoHop = new ArrayList<Integer>();
		 // get one hop neighbors from v
		 List<Integer> oneHop = adjListsMap.get(v);
		 // iterate thru one hop neighbors 
		 for (Integer oneHopVert : oneHop) {
			 // get their one hop neighbors and add them to two hop list
			 twoHop.addAll(adjListsMap.get(oneHopVert));
		 }
		 // return list
		 return twoHop;
	}
